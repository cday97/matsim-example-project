...
public class RunPNetworkGenerator {
    ...
    public static void main(String[] args) {
         ...
         * The input file name.
         */
        String path = "D:\\Users\\chris\\Documents\\CSDSchool\\MatSimClass\\projects\\matsim-example-project\\src\\main\\java\\org\\activitysim\\data\\";
        String osm = path + "utah.osm";
         ...
         */
        new NetworkWriter(network).write(path + "utah_network.xml");
